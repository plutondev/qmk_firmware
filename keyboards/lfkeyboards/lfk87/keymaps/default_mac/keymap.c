...
#define MOD_CTRL MT(MOD_LCTL, KC_CAPS)
#define MOD_LGUI MT(MOD_LALT, KC_LGUI)

#define _MAC VANILLA
#define _WIN VANILLA_WIN
#define _SET SETTINGS
...
const Layer_Info layer_info[] = {
    ...
    {0x00000000, 0xFFFFFFFF, {0x00, 0x00, 0x00}}, // base layer - off, macintosh layout
    {0x00000002, 0xFFFFFFFF, {0x00, 0x7F, 0x00}}, // win layer - green
    {0x00000004, 0xFFFFFFFF, {0x00, 0x00, 0x7F}}, // function layer - blue
    {0x00000008, 0xFFFFFFFF, {0x7F, 0x00, 0x00}}, // settings layer - red
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [VANILLA] = LAYOUT_tkl_ansi(
    ...
    MOD_CTRL,KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,           KC_ENT,                                  \
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,                    KC_RSFT,               KC_UP,            \
    KC_LCTL, KC_LALT, KC_LGUI,                            KC_SPC,                             KC_RGUI, KC_RALT, MO(FUNC), KC_RCTL,      KC_LEFT, KC_DOWN, KC_RGHT  \
  ),
   ...
   * |Esc  |f1| f2| f3| f4|  | f5| f6| f7| f8|   | f9|f10|f11|f12  |  |Prnt|ScLk|Paus|
   * |-------------------------------------------------------------|  |--------------|
   * | ` |F1 |F2 |F3 |F4 |F5 |F6 |F7 |F8 |F9 |F10|F11|F12|Delete   |  |    |  TG(WIN)|
   * |-------------------------------------------------------------|  |--------------|
   * |Tab  |   |PgU|   |   |   |   |   | Up|   |   |   |   |       |  |    |    |    |
   * |-------------------------------------------------------------|  `--------------'
  ...
  [FUNC] = LAYOUT_tkl_ansi(
    ...
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_DEL,            _______, _______, TG(_WIN), \
  ...
  [SETTINGS] = LAYOUT_tkl_ansi(
    ...
    KC_FN5,  KC_FN2,  KC_FN4,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, MU_TOG,  XXXXXXX, XXXXXXX, XXXXXXX,                   TG(SETTINGS),          RGB_HUI,          \
