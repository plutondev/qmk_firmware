...
#define MOD_RGUI MT(MOD_RALT, KC_RGUI)

#define _MAC VANILLA_MAC
#define _WKL VANILLA_WKL
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
     ...
     * ,-------------------------------------------------------------.  ,--------------.
     * |     |f1| f2| f3| f4|  | f5| f6| f7| f8|   | f9|f10|f11|f12  |  |Prnt|    |Paus|
     * |-------------------------------------------------------------|  |--------------|
     * |   |F1 |F2 |F3 |F4 |F5 |F6 |F7 |F8 |F9 |F10|F11|F12|Delete   |  |    |    | MAC|
     * |-------------------------------------------------------------|  |--------------|
     * |Tab  |   |PgU|   |   |   |   |   | Up|   |   |   |   |   |   |  |    |    | WKL|
     * |---------------------------------------------------------.   |  `--------------'
    ...
    [SETTINGS] = LAYOUT_tkl_iso(
                                ...
                                KC_FN7,  XXXXXXX, KC_FN4,  KC_FN6,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, MU_TOG,  XXXXXXX, XXXXXXX, XXXXXXX,          TG(_SET),              RGB_HUI,          \
